package com.example.gajju.smartvtu;

/**
 * Created by gajju on 4/2/2017.
 */
...
public class AppBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        divisions.add("Subject Hour");
        divisions.add("Data structure");
        divisions.add("networking");
        divisions.add("operating system");
        divisions.add("javasript");
        divisions.add("cyber security");
        divisions.add("web technology");
